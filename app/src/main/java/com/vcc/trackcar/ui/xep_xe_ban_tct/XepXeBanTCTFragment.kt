package com.vcc.trackcar.ui.xep_xe_ban_tct
...
import kotlinx.android.synthetic.main.xep_xe_ban_tct_fragment.*
import kotlinx.android.synthetic.main.xep_xe_ban_tct_fragment.rcv_list_book_car
import kotlinx.android.synthetic.main.xep_xe_ban_tct_fragment.tv_no_data

class XepXeBanTCTFragment : Fragment(), OnItemBookListener {

    companion object {
        const val TYPE_MENU = 8
        fun newInstance() = XepXeBanTCTFragment()
    }

    private lateinit var viewModel: XepXeBanTctViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.xep_xe_ban_tct_fragment, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(XepXeBanTctViewModel::class.java)
        initView()
        initData()
    }
    ...
    private fun filterListBookCar(statusDriverBoard: String) {
        val listFillted = Observable.fromIterable<LstBookCarDto>(viewModel.listBookCar)
            .filter { lstBookCarDto: LstBookCarDto -> lstBookCarDto.statusDriverBoard == statusDriverBoard }
            .toList().blockingGet()

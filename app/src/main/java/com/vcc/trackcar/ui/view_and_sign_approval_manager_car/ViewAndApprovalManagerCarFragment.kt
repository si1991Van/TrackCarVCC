package com.vcc.trackcar.ui.view_and_sign_approval_manager_car
...
import com.vcc.trackcar.remote.API.service
...
class ViewAndApprovalManagerCarFragment : Fragment(), OnItemBookListener {
    ...
    companion object {
        const val TYPE_MENU = 5
        fun newInstance() = ViewAndApprovalManagerCarFragment()
    }

    private var mainActivcity: MainActivity? = null
    private lateinit var listBookCarAdapter: ListBookCarAdapter

    private lateinit var viewModel: ViewAndApprovalManagerCarViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.view_and_approval_manager_car_fragment, container, false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        viewModel = ViewModelProviders.of(this).get(ViewAndApprovalManagerCarViewModel::class.java)
        initView()
        initData()
    }
    ...
    private fun initData() {
        ...
        service.getListBookCar(body).subscribeOn(Schedulers.io()) //(*)
    ...
    private fun prepareBodyGetListBookCarBody(): GetListBookCarBody? {
        ...
        return GetListBookCarBody(
            authenticationInfo, userLogin.sysUserId, TYPE_MENU, userLogin.email, userLogin.loginName
        ) // 19244
    }
    ...
    private fun filterListBookCar(statusManagerCar: String) {
        val listFillted = Observable.fromIterable<LstBookCarDto>(viewModel.listBookCar)
            .filter { lstBookCarDto: LstBookCarDto -> lstBookCarDto.statusManagerCar == statusManagerCar }
            .toList().blockingGet()

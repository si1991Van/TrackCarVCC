package com.vcc.trackcar.ui.direction;
...
public class DirectionFinder {
    ...
    private static final String GOOGLE_DIRECTION_API_KEY = "AIzaSyArTdhzQmN1HTzNumYvNaKd_foe0MMRgqQ";  // replace with your google direction api
    ...
    public DirectionFinder(DirectionFinderListener listener, String origin, String destination) {
        ...
        this.origin = origin + ", VN";
        this.destination = destination + ", VN";
    }
